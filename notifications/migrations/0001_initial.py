    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='notifications.team')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('org', 'Organization'), ('team', 'Team'), ('user', 'User')], default='org', max_length=10)),
                ...
                ('target_users', models.ManyToManyField(blank=True, related_name='direct_alerts', to=settings.AUTH_USER_MODEL)),
                ('target_teams', models.ManyToManyField(blank=True, related_name='alerts', to='notifications.team')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deliveries', to='notifications.alert')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snoozed_on', models.DateField(blank=True, null=True)),
                ('last_reminded_at', models.DateTimeField(blank=True, null=True)),
                ('first_seen_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('alert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_preferences', to='notifications.alert')),
